...
std::string PoissonSurfaceReconstructrion::reconstruct  (FT sm_angle, FT sm_radius, FT sm_distance)
{
    ...
    Poisson_reconstruction_function function(pointsPSR.begin(),
                                             pointsPSR.end(),
                                             CGAL::make_normal_of_point_with_normal_pmap( PointList::value_type() ));
    ...
    FT average_spacing = CGAL::compute_average_spacing<CGAL::Sequential_tag>(pointsPSR.begin(), pointsPSR.end(), 6);
